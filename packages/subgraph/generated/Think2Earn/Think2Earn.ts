...
export class Think2Earn__getBountiesResultValue0Struct extends ethereum.Tuple {
  ...
  get submissions(): Array<
    Think2Earn__getBountiesResultValue0SubmissionsStruct
  > {
...
export class Think2Earn extends ethereum.SmartContract {
  ...
  getBounties(): Array<Think2Earn__getBountiesResultValue0Struct> {
    let result = super.call(
      "getBounties",
      "getBounties():((string,string,string,uint256,uint256,uint256,uint256,uint256,address,bool,(address,bytes32)[])[])",
      []
    );
  ...
  getBountySubmissions(
    ...
    let result = super.call(
      "getBountySubmissions",
      "getBountySubmissions(uint256,uint256):((address,bytes32))",
      [
        ethereum.Value.fromUnsignedBigInt(_bountyId),
  ...
  submitEEGData(_bountyId: BigInt, _eegDataHash: Bytes): BigInt {
    let result = super.call(
      "submitEEGData",
      "submitEEGData(uint256,bytes32):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(_bountyId),
        ethereum.Value.fromFixedBytes(_eegDataHash)
      ]
    );
